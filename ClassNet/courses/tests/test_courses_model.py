...
class CourseMaterialModelTestCase(TestCase):
...
class MaterialCompletionModelTestCase(TestCase):
...
class TeacherNotificationModelTestCase(TestCase):
...
class StudentNotificationModelTestCase(TestCase):
